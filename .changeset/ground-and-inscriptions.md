...
Ground work: the field inside the frame and outside the picture can now be printed with engine-turned guilloche, burelage, cross-hatch, a graded panel, stipple or a halftone screen. Each carries its own colour, weight, pitch, angle and strength, and can run under the picture instead of stopping at the window.
